...
for (group in 1:nrow(groups)) {
  ...
  for (i in 1:plotrows) {
    ...
    rect(xleft=rgyw-0.5,ybottom=-1,xright=rgyw+3.5,ytop=ymax,col="orange",border=F)
    rect(xleft=agct-0.5,ybottom=-1,xright=agct+3.5,ytop=ymax,col="orangered3",border=F)
...
# 	rect(xleft=dgyw-0.5,ybottom=refy,xright=dgyw+3.5,ytop=ymax,col=rgb(255,247,188,max=255),border=F)
    rect(xleft=rgyw-0.5,ybottom=refy,xright=rgyw+3.5,ytop=ymax,col="orange",border=F)
    rect(xleft=agct-0.5,ybottom=refy,xright=agct+3.5,ytop=ymax,col="orangered3",border=F)
    grid(col=grey(0.5))
